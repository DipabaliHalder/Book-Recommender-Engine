...
with open('book_list.pkl') as fin:
    pickle.load(fin)
...
if selected=="Recommend" or selected=="About" or selected=="Github Repository":
    ...
    if(st.button('Recommend')):
        if(select_book==''):
            ...
            recommended_book_names, recommended_book_posters = recommend_books(select_book)
            col1, col2, col3, col4, col5 = st.columns(5)
            with col1:
